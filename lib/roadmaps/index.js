...
import { DATA_ML_ROADMAP } from './dataMl';
import { DEVOPS_CLOUD_ROADMAP } from './devopsCloud';
import { MOBILE_ROADMAP } from './mobile';

export const ROADMAPS = {
  Frontend: FRONTEND_ROADMAP,
  Backend: BACKEND_ROADMAP,
  'Data & ML': DATA_ML_ROADMAP,
  'DevOps & Cloud': DEVOPS_CLOUD_ROADMAP,
